...
export const getAiImageQuery = (
  ...
  switch (query) {  
    case 'title': return 'Write a compelling title for this image in 3 words or less. Use Simplified Chinese.';
    case 'caption': return existingTitle
      ? `Write a pithy caption for this image in 10 Chinese characters or less and no punctuation that complements the existing title: "${existingTitle}." Use Simplified Chinese.`
      : 'Write a pithy caption for this image in 10 Chinese characters or less and no punctuation. Use Simplified Chinese.';
    case 'title-and-caption': return 'Write a compelling title and pithy caption for this image, using the format Title: "title" Caption: "caption." Use Simplified Chinese.';
    case 'tags':
      ...
      return tags
        ...
        : tagQuery;
    case 'semantic': return 'Describe this image succinctly without initial text like "This image shows" or "This is a picture of." Use Simplified Chinese.';
  }
};
...
export const getAiImageQuerySchema = (
  ...
  const queryLines = [
    'Generate a set of meta content for the attached image. All text must be in Simplified Chinese:\n',
  ];
